...
cd Common
C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\csc /out:..\bin\debug\TashjikCommon.dll /target:library AsyncCallback_Object.cs Bool_Object.cs Bool_ObjectAsyncResult.cs   Data.cs Data_AsyncCallback_Object.cs Data_Object.cs Data_ObjectAsyncResult.cs DataAsyncResult.cs NodeBasic.cs ObjectAsyncResult.cs TashjikAsyncResult.cs UtilityMethod.cs Exception\BytesLengthsNotMatchingException.cs Exception\LocalHostIPNotFoundException.cs


cd ../Tier0 
C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\csc /out:..\bin\debug\TashjikTier0.dll /r:..\bin\debug\TashjikCommon.dll /target:library ITransportLayerCommunicator.cs TransportLayerCommunicator.cs
...
cd ..
C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\csc /out:bin\debug\TashjikServer.dll /r:bin\debug\TashjikCommon.dll /r:bin\debug\TashjikTier0.dll  /target:library TashjikDataStream.cs OverlayServerFactory.cs OverlayController.cs OverlayServer.cs StreamingOverlayServer.cs TashjikServer.cs Node.cs IProxyNodeController.cs RealNode.cs ProxyNode.cs ProxyNodeController.cs 

cd Tier2
C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\csc /out:..\bin\debug\Tier2Common.dll /target:library DataNotFoundInStoreException.cs



rem C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\csc /out:..\bin\debug\Pastry.dll /r:..\bin\debug\TashjikServer.dll /r:..\bin\debug\TashjikTier0.dll /r:..\bin\debug\Tier2Common.dll /r:..\bin\debug\TashjikCommon.dll /r:..\bin\debug\TashjikBase.dll /target:library IPastryNode.cs PastryDataStore.cs PastryRealNode.cs PastryProxyNode.cs PastryServer.cs


C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\csc /out:..\bin\debug\Chord.dll /r:..\bin\debug\TashjikServer.dll /r:..\bin\debug\TashjikTier0.dll /r:..\bin\debug\Tier2Common.dll /r:..\bin\debug\TashjikCommon.dll /r:..\bin\debug\TashjikBase.dll  /target:library IChordNode.cs ChordDataStore.cs ChordRealNode.cs ChordProxyNode.cs ChordServer.cs ChordCommon\IChordNode_Object.cs chordCommon\IChordNode_ObjectAsyncResult.cs chordCommon\ByteKey_IChordNode.cs
...
rem C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\csc /out:..\bin\debug\Tier0TestReceiver.exe /r:..\bin\debug\TashjikCommon.dll /r:..\bin\debug\TashjikTier0.dll DataReceiver.cs 
